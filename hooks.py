...
scheduler_events = {
    "cron": {
        # Every minute: process queued items
        "* * * * *": [
            "beetwin_iot.beetwin_iot.api.queue_processor.process_device_queue_async"
        ],
        # Daily at 03:00 IST: delete 'Done' records from Device Data Queue
        "*/15 * * * *": [
            "beetwin_iot.beetwin_iot.api.queue_processor.cleanup_device_data_queue"
        ],
    }
}
...
website_route_rules = [{'from_route': '/milman/<path:app_path>', 'to_route': 'milman'}, {'from_route': '/vertive/<path:app_path>', 'to_route': 'vertive'}, {'from_route': '/beetwin_hs/<path:app_path>', 'to_route': 'beetwin_hs'}, {'from_route': '/iotweet-dashboard/<path:app_path>', 'to_route': 'iotweet-dashboard'},]
# Add this line
app_include_js = "/assets/beetwin_iot/js/beetwin_iot.js"
