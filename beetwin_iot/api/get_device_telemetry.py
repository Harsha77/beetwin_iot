...
# =============================================================================
# FUNCTION: filter_valid_telemetry
# DESCRIPTION:
#   Helper function that filters telemetry key-value entries by ignoring
#   any key starting with 't' and only allowing a defined set of valid keys.
# PARAMS:
#   entries (list): List of key-value telemetry entries.
# RETURN:
#   Dictionary of filtered telemetry values.
# =============================================================================
...
# DESCRIPTION:
#   Fetches latest telemetry values for all devices from Device Telemetry 
#   and associated Key-Value child DocType.
#   Includes timestamp cleanup and ensures only meaningful data is returned.
# RETURN:
#   JSON response with status and telemetry data for all devices.
# =============================================================================
@frappe.whitelist(allow_guest=True)
def get_all_device_data():
    ...
    try:
        ...
        # Fallback: return only entries with valid telemetry fields
